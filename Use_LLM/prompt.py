...
Regardless of the language used in this prompt, please generate the output content in the same language as the input text. 
Maintain all specified field names (e.g., entity_name, type, claim_status) and output formats exactly as defined. 
Only adapt the descriptive content (entity names, descriptions, explanations) to match the input text's language.
"""
...
1. Each entity must be properly closed with ") before the next record delimiter ##
2. Each relationship must be properly closed with ") before the next record delimiter ##
3. Do not break entities or relationships across multiple lines
4. Ensure each record is complete and self-contained

EXAMPLE OF CORRECT FORMAT:
("entity"<|>"EntityName"<|>"EntityType"<|>"Complete description here")##
("relationship"<|>"Source"<|>"Target"<|>"Complete description here"<|>score)##

INVALID FORMAT (DO NOT DO THIS):
("entity"<|>"EntityName"<|>"EntityType"<|>"Incomplete desc("entity"<|>"NextEntity"...)
#############################
-Real Data-
######################
...
It appears some entities may have still been missed.  Answer YES | NO if there are still entities that need to be added. Be careful , Please answer in English, regrardless of the language used in the input text. Just in English,  Answer YES | NO.
"""
